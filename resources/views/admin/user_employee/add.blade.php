        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user-save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputImageEmployee">Upload Image Employee</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputImageEmployee" name="img">
                            <label class="custom-file-label" for="exampleInputImageEmployee">Choose file</label>
                        </div>
                    </div>
                    <div class="form-group">
